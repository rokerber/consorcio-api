...
public class SimulacaoServiceTest {
    ...
    void testCreditoAtualizado() {
        ...
        double creditoAtualizado3 = simulacaoService.gerarCreditoAtualizado(110,parametroRequestDTO,10).doubleValue();
        double creditoAtualizado4 = simulacaoService.gerarCreditoAtualizado(12,parametroRequestDTO,1).doubleValue();
        double creditoAtualizado5 = simulacaoService.gerarCreditoAtualizado(230,parametroRequestDTO,1).doubleValue();
        ...
        assertEquals(135743.33, creditoAtualizado3);
        assertEquals(62500.0, creditoAtualizado4);
        assertEquals(321353.83, creditoAtualizado5);
